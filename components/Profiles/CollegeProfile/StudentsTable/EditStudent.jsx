...
import Steptwo from "./../AddStudent/Steptwo.jsx";
import { get_progs } from "../../../../store/getandset.js";
import { Await, useLocation } from "react-router-dom";
import Stepone from "../AddStudent/Stepone.jsx";
import SelectStep from "../AddStudent/SelectStep.jsx";
let initialValues = {
  department: "",
  firstname: "",
  lastname: "",
...
const EditStudent = (props) => {
  ...
  const Stepthere = () => <></>;
  const currentstep = [<Stepone departments={departments} />, <Steptwo />, <Stepthere />];
  const selectStep = (e) => {
