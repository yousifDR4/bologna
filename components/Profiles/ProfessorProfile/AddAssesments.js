...
export default function AddAssesment(probs) {
  ...
  const [selectedDate,setSelectedDate]=React.useState(edit ? initialValues['date'] ||'':"");
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Please enter the exam information below(note that the grade will be rounded according to value specified in module information)
          </DialogContentText>
        ...
        >
            {selectedModuleObj?.AssesmentLab ? selectedModuleObj.AssesmentLab.activated && <MenuItem key="asl" value="AssesmentLab"> Lab Assesment</MenuItem>:""}
            {selectedModuleObj?.AssesmentOnline ? selectedModuleObj.AssesmentOnline.activated&&   <MenuItem key="aso" value="AssesmentOnline"> Online Assesment</MenuItem>:""}
            {selectedModuleObj?.AssesmentOnsight ? selectedModuleObj.AssesmentOnsight.activated &&  <MenuItem key="asos" value="AssesmentOnsight"> Onsight Assesment</MenuItem>:""}
            {selectedModuleObj?.AssesmentProject ? selectedModuleObj.AssesmentProject.activated && <MenuItem key="asp" value="AssesmentProject"> Project Assesment</MenuItem>:""}
            {selectedModuleObj?.AssesmentQuizes ? selectedModuleObj.AssesmentQuizes.activated &&  <MenuItem key="asq" value="AssesmentQuizes"> Quiz Assesment</MenuItem>:""}
            {selectedModuleObj?.AssesmentReports.activated ? selectedModuleObj.AssesmentReports.activated &&  <MenuItem key="asq" value="AssesmentReports"> Report Assesment</MenuItem>:""}
        </Select>
        </FormControl>
        <FormControl
              sx={{ marginTop:"0.4rem",minWidth: "8rem", width: "100%", paddingLeft: "0" }}
              size="small"
            >
